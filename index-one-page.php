...
<html lang="en">
	...
	<body id="body" class="one-page alternative-font-5" data-plugin-scroll-spy data-plugin-options="{'target': '#header'}">
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="row d-flex flex-md-row flex-column align-items-center doctor-card" style="margin-left: 15px;">
					<div class="col-md-6 text-center text-md-start">
							<h1 style="font-weight: bold; margin: 0px; color: black; font-size: 28px;" style="margin-right: 25p;">Dr. Kiran Buddaraju</h1>
							<p style="color: black; font-size: 20px;">MBBS, MD, DM</p>
							<p style="font-size: medium;">Dr. Kiran Buddaraju is a highly accomplished neurosurgeon with over 14 years of experience in diagnosing and treating complex neurological conditions. Specializing in brain and spinal surgeries, he is recognized for his precision, technical expertise, and patient-centered approach. His proficiency spans a wide range of procedures, including brain tumor removal, aneurysm repair, spinal cord injury management, and minimally invasive techniques that enhance recovery while reducing complications. Committed to continuous learning and innovation, Dr. Buddaraju stays at the forefront of neurosurgical advancements by integrating cutting-edge technologies such as neuro-navigation systems and robotic-assisted surgeries, ensuring optimal patient outcomes. Beyond his surgical expertise, he is deeply dedicated to patient care, emphasizing thorough diagnosis, personalized treatment plans, and long-term rehabilitation strategies. His compassionate approach and clear communication empower patients and their families with the knowledge and confidence they need throughout their medical journey. Through his unwavering commitment to excellence and innovation, Dr. Buddaraju has earned a strong reputation as a trusted name in neurosurgery, providing world-class treatment to those in need of specialized neurological care.</p>
							<a style="display: block; width: 200px; margin-left: 325px; " href="slot-booking.php" class="btn btn-primary btn-lg mt-3">Book an Appointment</a>
						</div>
					<div class="col-md-6 text-center mt-3" style="margin-bottom: 65px;">
							<img src="img/kiran_logo-removebg.png" alt="Dr. Kiran Buddaraju" class="doctor-img" style="margin-right:185px;">
					</div>
	...
	<style>
		.container {
    max-width: 100%; /* Makes it take more space */
    transform-origin: center; /* Keeps it centered */
}

.doctor-card {
    width: 120%; /* Increases width */
...
.doctor-img {
    width:40%; /* Increases image size */
    height: auto;
}

.btn-primary {
    font-size: 32px; /* Increases button text size */
    padding: 20px 40px; /* Enlarges button */
}
